...
extern float outdoorTemperature, outdoorPressure, outdoorHumidity, outdoorPm25, outdoorPm10, outdoorCo2, outdoorTvoc, latitude, longitude;
...
String getCo2()
{
  String payload;
  int httpCode;
  int lastOpeningQuote = 0;
  int lastClosingQuote = 0;
  if ((WiFi.status() == WL_CONNECTED))
  {
    HTTPClient http;
