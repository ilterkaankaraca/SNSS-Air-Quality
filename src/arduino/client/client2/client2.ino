...
void transmitValues()
{
  ...
  { //Check the current connection status
    HTTPClient http;
    http.begin("http://" + serverIp.toString() + "/readValue2/?temperature=" + String(indoorTemperature) + "&humidity=" + String(indoorHumidity) + "&co2=" + String(indoorCo2) + "&tvoc=" + String(indoorTvoc) + "&pressure=" + String(indoorPressure) + "&pm25=" + String(indoorPm25) + "&pm10=" + String(indoorPm10));
