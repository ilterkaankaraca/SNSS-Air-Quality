namespace AirQuality.MWM.Model
{
    class AirInformation
    {
        ...
        private int outdoorTemperature, indoorTemperature;
        private double indoorHumidity, indoorCo2, indoorTvoc, indoorPressure, indoorPm25, indoorPm10;
        private double  outdoorHumidity, outdoorCo2, outdoorTvoc, outdoorPressure, outdoorPm25, outdoorPm10;
